...
//                 <thead>
//                 <tr>
//                   <th>Người đăng<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm"
//                                        placeholder="Text input"/> {data.name}</th>
//                   <th>Ngày<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm"
//                                  placeholder="Text input"/>{data.mobile_phone}</th>
//                   <th>Dự án<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm"
//                                   placeholder="Text input"/></th>
//                   <th>Chủ đầu tư<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm"
//                                        placeholder="Text input"/></th>
//                   <th>Khu vực<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm"
//                                     placeholder="Text input"/></th>
//                   <th>báo xấu<Input bsSize="sm" type="text" id="input-small" name="input-small" className="input-sm"
//                                     placeholder="Text input"/></th>
//                   <th>Chi tiết</th>
//
//                 </tr>
            ...
            <CardHeader>
              <div>
                <Row>
                  ...
                  <Col sm="4" xl="4">
                    <div>
                      <p>Số điện thoại :<Input id="mobilePhone" defaultValue={data.mobile_phone}  onChange={(event) => this.handleBuildingsDataChange(event)}/></p>
              ...
              <div>
                <Row>
                  ...
                  <Col xs="12" md="4">
                    <p>Số căn hộ sở hữu: </p>
                    <p>Địa chỉ:
                      <Input id="address" defaultValue={data.address}  onChange={(event) => this.handleBuildingsDataChange(event)}/></p>
                  </Col>
                  <Col xs="12" md="4">
                    <p>Số lần bị report: </p>
                  </Col>
