        ...
        if(responseJson.data) {
          const getAlert = () => (
            <SweetAlert
              success
              timeout={1500}
              onConfirm={() => {this.hideAlert();this.state.data.splice(index,1)}}
            >
                        ...
                        <CardBody>
                          <Table responsive>
                            ...
                            <tr>
                              ...
                              <th style={styles.topVertical}>Avatar</th>
                              ...
                              <th>Số ĐT<Input bsSize="sm" type="text" id="mobile_phone" name="mobile_phone"
                                              className="input-sm" placeholder="Tìm kiếm"
                                              onChange={(event) => this.handleChange(event)}/></th>
                              <th>Email<Input bsSize="sm" type="text" id="email" name="email"
                                              className="input-sm" placeholder="Tìm kiếm"
                                              onChange={(event) => this.handleChange(event)}/></th>
                              <th style={styles.topVertical}>Địa chỉ</th>
